...
public class HomePageVol extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_page_vol);
        setTitle("Let's Teach");
        ...
        final RecyclerView mainLists = (RecyclerView) findViewById(R.id.listView);
        ...
        mainListObj.add(new ListBean(1,"AmeriCorps","National NGO that helps those in need"));
        mainListObj.add(new ListBean(2,"Teach For America","National NGO that helps teach"));
        mainListObj.add(new ListBean(2,"Stand for Children","NGO that helps children"));
        ...
        adapter.setOnItemClickListener(new MainListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent i = new Intent(HomePageVol.this, ProfileFragmentOrg.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.home_page_vol, menu);
